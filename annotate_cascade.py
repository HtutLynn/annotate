...
class DigitsPreprocess(object):
    ...
    def __call__(self, image):
        ...
        batch_img[0] = self._preprocess_digit_crop(image[56:97, 43:72, :].copy())
        batch_img[1] = self._preprocess_digit_crop(image[56:97, 71:95, :].copy())
        batch_img[2] = self._preprocess_digit_crop(image[56:97, 120:143, :].copy())
        batch_img[3] = self._preprocess_digit_crop(image[56:97, 141:167, :].copy())
        batch_img[4] = self._preprocess_digit_crop(image[56:97, 191:215, :].copy())
        batch_img[5] = self._preprocess_digit_crop(image[56:97, 214:240, :].copy())
        batch_img[6] = self._preprocess_digit_crop(image[56:97, 238:264, :].copy())
        batch_img[7] = self._preprocess_digit_crop(image[56:97, 262:289, :].copy())
        batch_img[8] = self._preprocess_digit_crop(image[56:97, 405:434, :].copy())
        batch_img[9] = self._preprocess_digit_crop(image[56:97, 430:458, :].copy())
        batch_img[10] = self._preprocess_digit_crop(image[56:97, 476:504, :].copy())
        batch_img[11] = self._preprocess_digit_crop(image[56:97, 502:529, :].copy())
        batch_img[12] = self._preprocess_digit_crop(image[56:97, 548:576, :].copy())
        batch_img[13] = self._preprocess_digit_crop(image[56:97, 573:603, :].copy())
