...
def parse_args():
    ...
    parser.add_argument("--detect_engine", type=str, default="checkpoints/trt/efficientdet-d1.trt")
    parser.add_argument("--featext_engine", type=str, default="checkpoints/trt/extractor.trt")
    parser.add_argument("--digits_engine", type=str, default="checkpoints/trt/digits.trt")
