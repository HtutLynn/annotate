...
class CascadeModel(object):
    ...
    Cascade model : YOLOv4 trt/EfficientDet trt model ==> detections => Feature Extractor trt model ==> features.
    ...
    def __init__(self, model, detect_engine_path, featext_engine_path,
